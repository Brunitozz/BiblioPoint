...
export const SideBarCuenta = () => {
  ...
  const links = [
    ...
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2a10 10 0 0 0-7.5 16.6l-1.5 1.5l1.4 1.4l1.5-1.5A10 10 0 1 0 12 2zm0 2a8 8 0 0 1 5.1 14.1l-1.4-1.4A6 6 0 0 0 12 6zm-2 5a2 2 0 1 1 4 0a2 2 0 0 1-4 0zm-2 8l-2 2l1.4 1.4l2-2z" /></svg>
      ),
    },
    {
      name: 'Perfil',
  ...
  return (
    <aside className="fixed top-[75px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
